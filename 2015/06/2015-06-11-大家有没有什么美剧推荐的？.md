...
![](http://ww1.sinaimg.cn/large/610dc034jw1eszzqri8otj20mb0di75p.jpg)
...
* [又一个日期控件](http://git.oschina.net/yugecse/CalendarWidget) (有时放纵 }
* [为Android提供不可改变的数据集支持](https://github.com/konmik/solid) (mthli }
* [图片loading的效果](https://github.com/florent37/MaterialImageLoading) (Jason }
* [顶级的Twitter第三方客户端Talon for Twitter源码](https://github.com/klinker24/Talon) (mthli }

### 瞎推荐

* [把你的图片转换成音频听听看](https://github.com/kylophone/spectro) (tiiime }
* [清晰的 Git 图形管理界面](http://gitup.co/) (tiiime }

### 休息视频

* [【国内黑科技】风火轮！！真的就是风火轮！！！](http://www.bilibili.com/video/av2397080/) (LHF }
